...
echo "Usage: ./release_kylin_store.sh version arch[amd64, arm64, loongarch64, sw64]."
exit 0
fi
...
cp -af ../../../../../../build/icons/96x96.png hicolor/96x96/apps/cn.wildfirechat.pcclient.png
