...
class WfcImpl {
    ...
    onSecretMessageBurnedListener(longArrayStr) {
        console.log('onSecretMessageBurnedListener', longArrayStr);
    }
    ...
    init(args = []) {
        ...
        proto.setSecretChatStateListener(self.onSecretChatStateChangedListener);
        proto.setSecretMessageBurnStateListener(self.onSecretMessageStartBurningListener, self.onSecretMessageBurnedListener);
    ...
    getSecretChatInfo(targetId) {
        ...
        //需要创建SecretChatInfo结构体，然后转换成结构体返回
        return secretChatInfoStr;
    }

    //byte[]
    decodeSecretChatMediaData(mediaDatas) {
        return proto.decodeSecretChatMediaData(mediaDatas);
    }
