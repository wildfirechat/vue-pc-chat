...
class WfcImpl {
    ...
    onReceiveMessage(messages, hasMore) {
        ...
        msgs.forEach(m => {
            ...
            if (msg.messageContent instanceof MarkUnreadMessageContent) {
                ...
                proto.setLastReceivedMessageUnRead(JSON.stringify(conversation), stringValue(markMsg.messageUid));
            }
            if (msg) {
    ...
    markConversationAsUnread(conversation, syncToOtherClient) {
        let msgUid = proto.setLastReceivedMessageUnRead(JSON.stringify(conversation), '0');
