<template>
    <div>
        <TextMessageContentView :message="message"
                                ...
                                :style="{'--out-arrow-color':'var(--bg-msg-out)', '--in-arrow-color':'var(--bg-msg-in)'}"
        ...
        <UserCardMessageContentView :message="message"
                                    ...
                                    :style="{'--out-arrow-color':'var(--bg-primary)', '--in-arrow-color':'var(--bg-primary)'}"
                                    v-bind:class="{leftarrow:message.direction === 1, rightarrow: message.direction === 0}"/>
...
import TextMessageContentView from "../../../main/conversation/message/content/TextMessageContentView";
import ImageMessageContentView from "../../../main/conversation/message/content/ImageMessageContentView";
import VideoMessageContentView from "../../../main/conversation/message/content/VideoMessageContentView";
import UnsupportMessageContentView from "../../../main/conversation/message/content/UnsupportMessageContentView";
import FileMessageContentView from "../../../main/conversation/message/content/FileMessageContentView";
import StickerMessageContentView from "../../../main/conversation/message/content/StickerMessageContentView";
import CallStartMessageContentView from "../../../main/conversation/message/content/CallStartMessageContentView";
// 语音消息说明
//  目前提供连个实现版：
