...
class WfcImpl {
    ...
    init(args = []) {
        ...
        protoRenderer.setProtoEventListener('connectionStatus', (status) => {
            self.onConnectionChanged(status);
            // TODO 已经支持了，这儿不用转了，移除相关代码
            // this._forwardToOtherWindow('connectionStatus', status)
        });
        protoRenderer.setProtoEventListener('connectToServer', (host, ip, port) => {
        ...
        protoRenderer.setProtoEventListener('onReceiveMessage', (messages, hasMore) => {
            // onReceiveMessage
