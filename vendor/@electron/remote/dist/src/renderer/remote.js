...
function wrapArgs(args, visited = new Set(), memberName = '') {
    ...
    for (const member of members) {
        ...
        if (member.type === 'method') {
            const remoteMemberFunction = function (...args) {
                ...
                const ret = electron_1.ipcRenderer.sendSync(command, contextId, metaId, member.name, wrapArgs(args, new Set(), member.name));
