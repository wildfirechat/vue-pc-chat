...
class WfcImpl {
    ...
    async searchUserEx(domainId, keyword, searchType, page, successCB, failCB) {
        protoProxy.invokeAsync('searchUser', domainId, keyword, searchType, page, (result) => {
            let userListStr = JSON.parse(result);
            let userList = [];
            if (userListStr && userListStr.length > 0) {
                userListStr.forEach(u => {
    ...
    getDomainInfo(domainId) {
        let domainInfoStr = protoProxy.invoke('getDomainInfo', domainId);
        let domainInfo;
        if (domainInfoStr === '') {
    ...
    _setupEventListeners() {
        ...
        protoProxy.setProtoEventListener('groupInfoUpdate', (domainInfoStr) => {
