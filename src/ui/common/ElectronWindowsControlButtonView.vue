        ...
        <div class="titlebar-stoplight">
            ...
            <div class="titlebar-minimize" @click="minimize" v-if="sharedMiscState.enableMinimize">
                <svg x="0px" y="0px" viewBox="0 0 8 1.1">
                    <rect fill="var(--mac-yellow-dark)" width="8" height="1.1"></rect>
                </svg>
            </div>
            <div class="titlebar-fullscreen" @click="maximize" v-if="maximizable">
                <svg class="fullscreen-svg" x="0px" y="0px" viewBox="0 0 6 5.9">
                    <path fill="var(--mac-green-dark)" d="M5.4,0h-4L6,4.5V0.6C5.7,0.6,5.3,0.3,5.4,0z"></path>
                    <path fill="var(--mac-green-dark)" d="M0.6,5.9h4L0,1.4l0,3.9C0.3,5.3,0.6,5.6,0.6,5.9z"></path>
                </svg>
                <svg class="maximize-svg" x="0px" y="0px" viewBox="0 0 7.9 7.9">
                    <polygon fill="var(--mac-green-dark)"
...
.titlebar-close {
    border: 1px solid var(--mac-close-hover);
    background-color: var(--mac-red);
    margin-left: 6px;
}

.titlebar-close:active {
    border-color: var(--mac-red-active);
    background-color: var(--mac-red-active);
}
...
.titlebar-minimize {
    border: 1px solid var(--mac-yellow-active);
    background-color: var(--mac-yellow);
}

.titlebar-minimize:active {
    border-color: var(--mac-yellow-active);
    background-color: var(--mac-yellow-active);
}
...
.titlebar-fullscreen,
.titlebar-maximize {
    border: 1px solid var(--mac-green-active);
    background-color: var(--mac-green);
}

.titlebar-fullscreen:active {
    border-color: var(--mac-green-active);
    background-color: var(--mac-green-active);
}
...
#window-controls .button:hover {
    background: var(--background-trans-subtle);
}
...
#min-button:hover {
    background: var(--background-item-placeholder) !important;
}
...
#close-button:active {
    background: var(--background-error-subtle) !important;
}
